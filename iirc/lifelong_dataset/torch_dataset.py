...
class Dataset(BaseDataset, data.Dataset):
    """
     A class inheriting from BaseDataset to be used with PyTorch
     ...
     Args:
         ...
         superclass_data_pct (float) : The percentage of samples sampled for each superclass from its consistent
            subclasses.
