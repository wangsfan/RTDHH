    ...
    def _divide_data_across_tasks_IIRC(self, superclass_data_pct, subclass_data_pct,
        ...
        for classes_combination in classes_combinations:
            ...
            if len(classes_combination) == 2:
                ...
                #     print(f"nums({superclass}),nums({subclass}) = {superclass_data_len},{subclass_data_len}")
                #     if data_subset_idx[:superclass_data_len] == []:
                #         print("data_subset_idx[:superclass_data_len] is [] !")
                #     print("cla_to_data_idx[electronic_equipement]:", cla_to_data_idx[superclass])
        ...
        # Nums_electronic_equipement = len(cla_to_data_idx["electronic_equipement"])
        # print(f"Nums(electronic_equipement) = {Nums_electronic_equipement}")
        ...
        for task_id in range(len(tasks)):
            ...
            task_id_to_data_idx[task_id] = sorted(list(set(task_id_to_data_idx[task_id]))) # 没该操作保证不了可复现性！！
