...
class Model(BaseMethod):
    """
    A method that only provides feedback for the classes that belong to the task of the sample (masks other tasks
    classes when computing the loss).
    """
...
class Buffer(BufferBase):
    ...
    def _construct_exemplar_set(self, task_data : Dataset, dist_args=None, **kwargs) -> None:
        """
