...
class ResNetCIFAR(nn.Module):
    def __init__(self, num_classes=10, num_layers=20, relu_last_hidden=False):
        ...
        if num_layers not in [20, 32, 44, 56, 110]:
            ...
            self.convnet = ResNetCIFARModule(BasicBlock, [3, 3, 3], num_classes, relu_last_hidden)
        elif num_layers == 32:
            self.convnet = ResNetCIFARModule(BasicBlock, [5, 5, 5], num_classes, relu_last_hidden)
        elif num_layers == 44:
            self.convnet = ResNetCIFARModule(BasicBlock, [7, 7, 7], num_classes, relu_last_hidden)
        elif num_layers == 56:
            self.convnet = ResNetCIFARModule(BasicBlock, [9, 9, 9], num_classes, relu_last_hidden)
        elif num_layers == 110:
            self.convnet = ResNetCIFARModule(BasicBlock, [18, 18, 18], num_classes, relu_last_hidden)
